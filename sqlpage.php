...
$id=$row['id'];
	...
	echo "<li><a href='ssqlpage.php?id=$id '>".$row['ptitle']."</a></li>" ;
}
...
<div class="contener">
  ...
  <a href="csspage.php"style="text-decoration: none;"><b style="font-size:30px;">LEARN SQL</b></a>
  ...
  <h2 style="color:blue;">SQL Example<h2>
